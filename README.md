...
| `companies_clean.csv` | Deduplicated and filtered |
| `companies_with_websites.csv` | With verified web presence |
| `companies_scraped.csv` | With scraped web content |
| `companies_final.csv` | Final clustered dataset |
| `embeddings.npy` | Pre-computed sentence-transformer embeddings |
| `clusters_final.html` | Interactive UMAP cluster visualisation |
